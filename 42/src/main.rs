...
fn sha512(data: &[u8]) -> [u8; 64] {
    ...
    let msg_len_bits = (msg_len as u128) * 8;
    ...
    padded.extend_from_slice(&(msg_len_bits >> 64).to_be_bytes());
    padded.extend_from_slice(&(msg_len_bits as u64).to_be_bytes());
